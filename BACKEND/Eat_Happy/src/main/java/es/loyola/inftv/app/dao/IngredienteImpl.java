...
public class IngredienteImpl implements Ingrediente {
	...
	@Override
	public int hashCode() {
		return Objects.hash(alergenos, descripcion, id, nombre);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IngredienteImpl other = (IngredienteImpl) obj;
		return Objects.equals(alergenos, other.alergenos) && Objects.equals(descripcion, other.descripcion)
