...
import es.loyola.inftv.app.services.ConsultarUsuarioServlet;

public class TestConsultarUsuario {
	...
	public void testDoPost() throws IOException,ServletException{
		...
		new ConsultarUsuarioServlet().doGet(request,response);
	...
	@Test
	public void test2DoGet() throws IOException,ServletException{
		HttpServletRequest request=mock(HttpServletRequest.class);   
		HttpServletResponse response=mock(HttpServletResponse.class);
